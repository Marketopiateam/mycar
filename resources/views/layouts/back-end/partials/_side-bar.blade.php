                ...
                <div class="navbar-vertical-content">
                        ...
                        @if (Helpers::module_permission_check('order_management'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/motors*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                            href="javascript:" title="{{ translate('serviescar') }}">
                                            <i class="tio-star nav-icon"></i>
                                            <span
                                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('serviescar') }}</span>
                                        </a>
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                            style="display: {{ Request::is('admin/motors*') ? 'block' : 'none' }}">
                                            <li class="nav-item {{ Request::is('admin/motors/create') ? 'active' : '' }}"
                                                title="{{ translate('add_new') }}">
                                                <a class="nav-link " href="{{ route('admin.motors.create') }}">
                                                    <span class="tio-circle nav-indicator-icon"></span>
                    ...
                    @if (Helpers::module_permission_check('product_management'))
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/services*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/services/create') ? 'active' : '' }}"
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/service-car*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('serviescar') }}">
                                <i class="tio-star nav-icon"></i>
                                <span
                        ...
                        <li  class="navbar-vertical-aside-has-menu {{ Request::is('admin/motors*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('motors') }}">
                                <i class="tio-star nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('motors') }}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/motors*') ? 'block' : 'none' }}">
                                <li class="nav-item {{ Request::is('admin/motors/create') ? 'active' : '' }}"
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/booking-service*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('booking_service') }}">
                                <i class="tio-star nav-icon"></i>
                                <span
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('in-House_Products') }}">
                    ...
                    @if (Helpers::module_permission_check('support_section'))
                        ...
                        <li
                            ...
                            <a class="nav-link" href="{{ route('admin.messages.index', ['type' => 'customer']) }}">

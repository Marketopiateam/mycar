...
Route::group(['namespace' => 'Web','middleware'=>['react:web','maintenance_mode','guestCheck']], function () {
...
Route::group(['namespace' => 'Web','middleware'=>['react:web','maintenance_mode','guestCheck']], function () {
    ...
    Route::controller(PageController::class)->group(function () {
        ...
        Route::get("delete-account", 'getDeleteAccountView')->name('del-acc');
        Route::post("delete-account", 'getDeleteAccountAction')->name('del-acc-act');
    });
    ...
    Route::get('delete_user', 'UserProfileController@delete_user')->name('delete_user');
...
//check done
Route::group(['prefix' => 'cart', 'as' => 'cart.', 'namespace' => 'Web', 'middleware'=>['react:web']], function () {
...
//Seller shop apply
Route::group(['prefix' => 'coupon', 'as' => 'coupon.', 'namespace' => 'Web', 'middleware'=>['react:web']], function () {
...
Route::group(['namespace' => 'Customer', 'prefix' => 'customer', 'as' => 'customer.', 'middleware'=>['react:web']], function () {
